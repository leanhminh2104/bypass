...
(function () {
    ...
    function injectPremiumCSS() {
        const css = `
            <style>
                ...
                body {
                    font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Segoe UI Emoji', sans-serif !important;
    ...
    function replaceWithPremiumLayout() {
        try {
                    ...
                    <div class="container">
                        <div class="navbar-header page-scroll">
                            <a class="navbar-brand logo-image" href="/">
                                <img src="/images/img/logo-trang-v2.png" alt="LAMDev">
                        ...
                        <div class="collapse navbar-collapse">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="https://dichvusale.io.vn">Hỗ trợ</a></li>
                ...
                <div class="main-content-area">
                    ...
                    <div class="success-card">
                        ...
                        <div class="success-feature">
                            <div>HOÀN TOÀN MIỄN PHÍ - KHÔNG CHI PHÍ ẨN</div>
                        </div>
                    </div>

                    <!-- Captcha Section -->
                    <div class="captcha-container">
                        <h3 class="captcha-title">🔒 VUI LÒNG GIẢI CAPTCHA ĐỂ TIẾP TỤC</h3>
                        ${mainForm.outerHTML}
                    </div>

                    <!-- Instructions -->
                    <div style="margin-top: 30px; color: #666; font-size: 15px;">
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-4">
                                    <div class="logo">
                                        ...
                                        <p>Chuyên gia bypass chuyên nghiệp</p>
                                    </div>
                                </div>
                                <div class="col-lg-4">
            ...
            // Thêm background gradient cho body
    ...
    async function init() {
        ...
        showQuickNotification('🚀 Đang khởi động hệ thống bypass...', 'info');
        
        // Inject CSS trước
        injectPremiumCSS();
        
        // Thử thay thế layout ngay lập tức
        ...
        const tryReplaceLayout = setInterval(() => {
            ...
            if (replaceWithPremiumLayout()) {
                ...
                showQuickNotification('✅ Giao diện đã được tối ưu!', 'success');
                
                // Inject script sau khi layout thành công
                setTimeout(async () => {
                    scriptSuccess = await injectMainScript();
                    if (scriptSuccess) {
                        showQuickNotification('✨ Script bypass đã chạy thành công!', 'success');
                    } else {
                        showQuickNotification('❌ Lỗi chạy script. Liên hệ admin!', 'error');
                    }
                }, 1000);
            } else if (attempts >= maxAttempts) {
                clearInterval(tryReplaceLayout);
                showQuickNotification('❌ Không thể tải giao diện. Vui lòng liên hệ admin: dichvusale.io.vn', 'error');
            }
        }, 500);
        ...
        setTimeout(() => {
            clearInterval(tryReplaceLayout);
            if (!layoutSuccess) {
                showQuickNotification('❌ Hệ thống quá tải. Vui lòng liên hệ admin: dichvusale.io.vn', 'error');
            }
        }, 5000);
    }
